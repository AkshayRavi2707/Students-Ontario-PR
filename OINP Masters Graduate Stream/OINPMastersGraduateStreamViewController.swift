//
//  OINPMastersGraduateStreamViewController.swift
//  Students Ontario PR
//
...
class OINPMastersGraduateStreamViewController: UIViewController {

    
    
    @IBAction func CallOINP(_ sender: Any) {
    ...
    @IBAction func EmailOINP(_ sender: Any) {
