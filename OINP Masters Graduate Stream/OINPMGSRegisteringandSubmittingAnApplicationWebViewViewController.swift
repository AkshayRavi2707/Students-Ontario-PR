//
//  OINPMGSRegisteringandSubmittingAnApplicationWebViewViewController.swift
//  Students Ontario PR
//
...
import UIKit
import WebKit
class OINPMGSRegisteringandSubmittingAnApplicationWebViewViewController: UIViewController {
